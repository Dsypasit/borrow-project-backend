...
export async function updateProductTotalAmount(id: any) {
...
export async function updateProductAvailableAmount(id: any) {
...
export async function updateProductUsageFrequency(id: any) {
  await prisma.product.update({
    where: {
      id: id,
    },
